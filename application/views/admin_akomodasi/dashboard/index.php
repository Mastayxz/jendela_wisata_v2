                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?= $akomodasi['alamat_akomodasi']; ?></td>
                                    <td>Rp. <?= number_format($akomodasi['harga_akomodasi']); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<script>
    var salesChart;
    var baseUrl = "<?= base_url('admin_ako/dashboard/get_pemesanan_data_akomodasi/' . $akomodasi['id_akomodasi']); ?>";
            ...
            options: {
                scales: {
                    y: {
                        beginAtZero: true,
                        ticks: {
                            stepSize: 1, // Set the step size to 1 for integer increments
