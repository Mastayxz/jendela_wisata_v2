<?php if (!empty($kategori)) : ?>
    ...
    ?>
        <tr>
            ...
            <td>
                <button class="btn btn-warning edit-btn" data-id="<?= $k->id_kategori; ?>" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit text-light"></i></button>
                <button class="btn btn-danger delete-btn" data-id="<?= $k->id_kategori ?>"><i class="fa fa-trash"></i></button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editModalLabel">Edit Data Data Jenis Akomodasi</h5>
...
<script>
    ...
    $(document).ready(function() {
        $('.edit-btn').on('click', function() {
            ...
            $.ajax({
                url: '<?= base_url('admin/kategori/ubahkategori/') ?>' + id,
                method: 'GET',
                dataType: 'html',
