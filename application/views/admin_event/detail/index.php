...
<?php if (!empty($event)) : ?>
    <div class="container-fluid">
        <div class="row justify-content-start my-4 ">
            <div class="col-md-3">
                <img src="<?= base_url() . '/upload/event/' . $event['gambar_event1']; ?>" width="400" height="300" alt="gambar1">
            </div>
            <div class="col-md-3">
                <img src="<?= base_url() . '/upload/event/' . $event['gambar_event2']; ?>" width="400" height="300" alt="gambar1">
            </div>1
            <div class="col-md-3">
                <img src="<?= base_url() . '/upload/event/' . $event['gambar_event3']; ?>" width="400" height="300" alt="gambar1">
            </div>
        </div>
        <div class="row mb-3 justify-content-start">
            <div class="col-lg-9 ">
                <a href="<?= base_url('admin_ako/dashboard'); ?>" class="btn btn-info"><span data-feather="arrow-left"></span> Go back</a>
                <button class="btn btn-warning edit-btn" data-id="<?= $admin_data['event']; ?>" data-toggle="modal" data-target="#editModal">Edit</button>
            </div>
